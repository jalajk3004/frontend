...
export function ExpandableTabs({
  ...
  const Separator = () => (
    <div className="mx-1 h-[24px] w-[1.2px]" aria-hidden="true" />
  );
  ...
  return (
    <div
      ref={outsideClickRef}
      className={cn(
        "flex flex-wrap text-emerald-900 items-center gap-2 rounded-2xl  p-1 shadow-sm",
        className
      )}
    >
      {tabs.map((tab, index) => {
          ...
          <motion.button
            ...
            className={cn(
              ...
              selected === index
                ...
                : "text-muted-foreground text-amber-950  hover:bg-muted hover:text-foreground"
            )}
          >
            <Icon size={20} />
